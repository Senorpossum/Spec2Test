...
export class TestGenerator {
        ...
        for (const entity of entities) {
            ...
            const invalidInputTest: TestCase = {
                ...
                steps: [
                    ...
                    {
                        order: 3,
                        action: "Verify the system rejects the input",
                        assertion: "Expected error response or validation message",
                    },
                ],
            ...
            const nullInputTest: TestCase = {
                ...
                steps: [
                    ...
                    {
                        order: 3,
                        action: "Verify the system handles gracefully",
                        assertion: "No crash, proper default or error handling",
                    },
                ],
            ...
            const largeInputTest: TestCase = {
                ...
                steps: [
                    ...
                    { order: 2, action: "Submit the large input" },
                    {
                        ...
                        assertion: "No memory exhaustion, graceful degradation or rejection",
                    },
                ],
        ...
        if (entities.some((e) => ["user", "login", "password", "email", "data", "input"].includes(e))) {
            const sqlInjectionTest: TestCase = {
                ...
                steps: [
                    ...
                    {
                        order: 3,
                        action: "Verify no unauthorized database access",
                        assertion: "Input is parameterized/sanitized",
                    },
                ],
    ...
    private generatePerformanceTests(story: UserStory): TestCase[] {
        ...
        const responseTimeTest: TestCase = {
            ...
            steps: [
                ...
                {
                    order: 3,
                    action: "Verify response time is within acceptable bounds",
                    assertion: "Response time < 2 seconds for typical operations",
                },
            ],
        ...
        const concurrentTest: TestCase = {
            ...
            steps: [
                ...
                {
                    order: 3,
                    action: "Verify system remains responsive",
                    assertion: "No degradation beyond acceptable thresholds",
                },
            ],
    ...
    private generateNegativeTest(criterion: AcceptanceCriterion, story: UserStory): TestCase {
        return {
            ...
            steps: [
                ...
                {
                    order: 3,
                    action: "Verify the action fails gracefully",
                    assertion: "Appropriate error or validation message",
                },
            ],
    ...
    private getTestId(prefix: string): string {
        const counter =
            prefix === "edge"
                ? this.edgeCaseCounter++
                : prefix === "error" || prefix.startsWith("error")
                  ? this.errorCaseCounter++
                  : this.testCounter++;
